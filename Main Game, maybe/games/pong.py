...
def move_ball():
    ...
    if ballMoveX < 0 and ballLeft < 0:
        ballMoveX = -ballMoveX
    # if ballMoveY < 0 and ballTop < 0: (for bouncing off of the ceiling)
        # ballMoveY = -ballMoveY
...
def reset():
    ...
    ballMoveX = 3
    ballMoveY = -6
    canvas.coords(bat1, 10, setBat1Top, 80, setBat1Bottom)  # default was 10, 50
    canvas.coords(bat2, 10, setBat2Top, 80, setBat2Bottom)
